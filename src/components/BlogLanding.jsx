...
const BlogLanding = () => {
  ...
  useEffect(() => {
    if (videoRef.current) {
      videoRef.current.play().catch(error => {import React, { useState, useEffect, useRef } from 'react';
import logo from '../assets/evolv_log.png';
...
const BlogLanding = () => {
  ...
  <div className="mb-[8vh] animate-float flex justify-center">
    <img 
      ...
      className="w-[clamp(260px, 30vw, 520px)] h-auto rounded-full border-[3px] border-evolv-green/30 mx-auto shadow-2xl hover:shadow-[0_0_40px_rgba(0,255,157,0.2)] transition-all duration-300"
    />
  </div>
